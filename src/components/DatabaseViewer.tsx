        ...
        <div className="flex items-center space-x-2">
          {onEvaluateAllJobs && (
            <button
              ...
              className="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold bg-emerald-600 hover:bg-emerald-500 text-white shadow-xs transition-colors cursor-pointer"
                    ...
                    <div className="flex items-center justify-end space-x-2">
                      {onEvaluateJob && job.score === undefined && (
                        <button
                          ...
                          className="inline-flex items-center px-2 py-1 rounded text-[11px] font-bold bg-emerald-50 text-emerald-700 hover:bg-emerald-100 border border-emerald-200 transition-colors cursor-pointer"
